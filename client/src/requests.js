const requests = {
    ...
    fetchActuallyGoodMovies: `https://api.themoviedb.org/3/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&sort_by=vote_average.des&include_video=en-US&page=1&vote_count.gte=100`
}
